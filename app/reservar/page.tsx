...
export const metadata: Metadata = {
  title: "Reserva tu asesoría · $70 · Con Henry",
};
    ...
    <Sitio reserva>
      <main id="contenido" className="site-container">
        <div className="booking-heading">
          ...
          <p>Elige tu momento. Nosotros nos ocupamos de acompañarte.</p>
        </div>
