...
export default function Gracias() {
  return (
    <main className="mx-auto flex min-h-dvh w-full max-w-[520px] flex-col justify-center px-6 py-10 text-center">
      <span
        aria-hidden="true"
        className="mx-auto flex size-16 items-center justify-center rounded-full bg-acento/20 text-acento"
      >
        <svg
          width="32"
          height="32"
      ...
      <h1 className="mt-6 font-titulo text-[38px] font-semibold leading-[1.08] tracking-[-0.02em]">
        Tu hora quedó apartada.
      </h1>

      <p className="mx-auto mt-4 max-w-[36ch] text-[17px] leading-[1.55] text-tinta-suave">
